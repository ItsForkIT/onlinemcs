...
def reportGen(request):
	...
	data1 = [
		["<b>Priority Needs</b>", "<b>Information</b>",],
	]

	i = 0
	dataHalf = []
	dataHalf.append('<b>&nbsp;Food Type Requirement</b><br/>')
	for i in range(0,len(context['FoodData'].keys())):
		dataHalf.append("&nbsp;&nbsp;&nbsp;(" + str(i+1) + ")" + str(context['FoodData'].keys()[i]) + "<br/>")


	data1.append(''.join(dataHalf))
	data1.append('17<br/>10<br/>15')
	data1[2] = data1[2] + ''
	...
	data = [
	["<b>Priority Needs</b>", "<b>Information</b>", ],
	["<b>&nbsp;Food Type Requirement</b><br/>&nbsp;&nbsp;&nbsp;(a) " + context['FoodData'].keys()[0]  + "<br/>&nbsp;&nbsp;&nbsp;(b) Wheat<br/>&nbsp;&nbsp;&nbsp;(c) Dal", str(context['FoodData'].values()[0])+ "<br/>" + str(context['FoodData'].values()[1]) + "<br/>" + str(context['FoodData'].values()[2])],
	]
	#["<b>&nbsp;Medicine Type Requirement</b><br/>&nbsp;&nbsp;&nbsp;(a) Fever<br/>&nbsp;&nbsp;&nbsp;(b) Typhoid<br/>&nbsp;&nbsp;&nbsp;(c) Jaundice", "<br/>02<br/>04<br/>06<br/>"],
	
	print '1Data:' + str(data)
